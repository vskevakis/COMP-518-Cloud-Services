    ...
    render() {
        return (
            <Animate type='fade' duration="500" show={this.state.show}>
                <div class="relative dark:bg-dark-dark bg-white min-h-full overflow-hidden">
                    <div class="max-w-7xl mx-auto">
                        <div class=" min-h-full relative z-10 pb-8 dark:bg-dark-dark bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
